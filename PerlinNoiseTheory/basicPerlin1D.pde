/*
Sample on building Perlin Noise - 1D, from scratch
Ramon Felip
*/
...
float[] generatePerlin(int num_x_Positions, int min_height, int max_height, int wavelength)
{
...
void draw()
{
  ...
  float[] heights = generatePerlin(num_points, min_h, max_h, waveLength);
